...
(function() {
  $(document).ready(function() {
    ...
    $('#currency, #currency_destination, #quantity').change(function() {
      var currency, currency_destination, has_values, is_diff, quantity;
      currency = $("#currency").val();
      currency_destination = $("#currency_destination").val();
      quantity = $("#quantity").val();
      ...
      if (has_values && is_diff) {
        return $("#exchange_form").submit();
      } else {
        return $("#result").val("");
      }
    });
    return $('img.icon-reverse').click(function() {
      var current_currency, current_destination;
      current_currency = $("#currency").val();
      current_destination = $("#currency_destination").val();
      $("#currency").val(current_destination);
      return $("#currency_destination").val(current_currency).trigger('change');
    });
  });
